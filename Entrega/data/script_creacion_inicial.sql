...
IF OBJECT_ID('FUSECHUDA.CUPON_DESC_RECLAMO','U') IS NOT NULL
  DROP TABLE FUSECHUDA.CUPON_DESC_RECLAMO
IF OBJECT_ID('FUSECHUDA.TIPO_CUPON','U') IS NOT NULL
  DROP TABLE FUSECHUDA.TIPO_CUPON
IF OBJECT_ID('FUSECHUDA.TIPO_CUPON_RECLAMO','U') IS NOT NULL
  DROP TABLE FUSECHUDA.TIPO_CUPON_RECLAMO
...
IF OBJECT_ID('FUSECHUDA.PEDIDO_ESTADO','U') IS NOT NULL
  DROP TABLE FUSECHUDA.PEDIDO_ESTADO
IF OBJECT_ID('FUSECHUDA.MENSAJERIA_ESTADO','U') IS NOT NULL
  DROP TABLE FUSECHUDA.MENSAJERIA_ESTADO
IF OBJECT_ID('FUSECHUDA.RECLAMO_ESTADO','U') IS NOT NULL
  DROP TABLE FUSECHUDA.RECLAMO_ESTADO
...
IF OBJECT_ID('FUSECHUDA.MIGRAR_TIPO_CUPON_RECLAMO') IS NOT NULL
  DROP PROCEDURE FUSECHUDA.MIGRAR_TIPO_CUPON_RECLAMO
...
IF OBJECT_ID('FUSECHUDA.MIGRAR_CUPON_DESC_RECLAMO') IS NOT NULL	DROP PROCEDURE FUSECHUDA.MIGRAR_CUPON_DESC_RECLAMO
IF OBJECT_ID('FUSECHUDA.MIGRAR_CUPON_PEDIDO') IS NOT NULL	DROP PROCEDURE FUSECHUDA.MIGRAR_CUPON_PEDIDO
IF OBJECT_ID('FUSECHUDA.MIGRAR_PEDIDO_ESTADO') IS NOT NULL	DROP PROCEDURE FUSECHUDA.MIGRAR_PEDIDO_ESTADO
IF OBJECT_ID('FUSECHUDA.MIGRAR_MENSAJERIA_ESTADO') IS NOT NULL	DROP PROCEDURE FUSECHUDA.MIGRAR_MENSAJERIA_ESTADO
IF OBJECT_ID('FUSECHUDA.MIGRAR_RECLAMO_ESTADO') IS NOT NULL	DROP PROCEDURE FUSECHUDA.MIGRAR_RECLAMO_ESTADO
...
CREATE TABLE FUSECHUDA.RECLAMO_ESTADO(
	ID_ESTADO [decimal](18, 0) IDENTITY(1,1) NOT NULL,
	DESCRIPCION NVARCHAR(50) NOT NULL
)
GO

CREATE TABLE FUSECHUDA.MENSAJERIA_ESTADO(
	ID_ESTADO [decimal](18, 0) IDENTITY(1,1) NOT NULL,
	DESCRIPCION NVARCHAR(50) NOT NULL
)
GO

CREATE TABLE FUSECHUDA.PEDIDO_ESTADO(
	ID_ESTADO [decimal](18, 0) IDENTITY(1,1) NOT NULL,
	DESCRIPCION NVARCHAR(50) NOT NULL
)
GO
...
CREATE TABLE FUSECHUDA.TIPO_CUPON_RECLAMO(
	ID_TIPO_CUPON_RECLAMO [decimal](18, 0) IDENTITY(1,1) NOT NULL, 
	TIPO_CUPON_RECLAMO [nvarchar](50) NOT NULL
)
GO

CREATE TABLE FUSECHUDA.CUPON_DESC_RECLAMO(
	NUMERO_RECLAMO_CUPON [decimal](18, 0) NOT NULL,
	NUMERO_RECLAMO [decimal](18, 0) NOT NULL, 
	ID_USUARIO [decimal](18, 0) NOT NULL,
	ID_TIPO_CUPON_RECLAMO [decimal](18, 0) NOT NULL,
	MONTO_RECLAMO [decimal](18, 2) NOT NULL,
	FECHA_RECLAMO_ALTA [datetime] NOT NULL,
	FECHA_RECLAMO_VENCIMIENTO [datetime] NULL
)
GO
...
ALTER TABLE FUSECHUDA.RECLAMO_ESTADO
	ADD CONSTRAINT PK_RECLAMO_ESTADO PRIMARY KEY (ID_ESTADO)

ALTER TABLE FUSECHUDA.MENSAJERIA_ESTADO
	ADD CONSTRAINT PK_MENSAJERIA_ESTADO PRIMARY KEY (ID_ESTADO)

ALTER TABLE FUSECHUDA.PEDIDO_ESTADO
	ADD CONSTRAINT PK_PEDIDO_ESTADO PRIMARY KEY (ID_ESTADO)
...
ALTER TABLE FUSECHUDA.PEDIDO
	ADD CONSTRAINT PK_NUMERO_PEDIDO PRIMARY KEY (NUMERO_PEDIDO),
		...
		CONSTRAINT FK_PEDIDO_ESTADO FOREIGN KEY (ID_ESTADO) REFERENCES FUSECHUDA.PEDIDO_ESTADO(ID_ESTADO)
...
ALTER TABLE FUSECHUDA.TIPO_CUPON_RECLAMO
	ADD	CONSTRAINT PK_TIPO_CUPON_RECLAMO PRIMARY KEY (ID_TIPO_CUPON_RECLAMO)
...
ALTER TABLE FUSECHUDA.RECLAMO
	ADD	CONSTRAINT PK_RECLAMO PRIMARY KEY (NUMERO_RECLAMO),
		...
		CONSTRAINT FK_RECLAMO_ESTADO FOREIGN KEY (ID_ESTADO) REFERENCES FUSECHUDA.RECLAMO_ESTADO(ID_ESTADO)
...
ALTER TABLE FUSECHUDA.CUPON_DESC_RECLAMO
	ADD	CONSTRAINT PK_CUPON_RECLAMO_NUMERO PRIMARY KEY (NUMERO_RECLAMO_CUPON),
		CONSTRAINT FK_CUPON_RECLAMO FOREIGN KEY (NUMERO_RECLAMO) REFERENCES FUSECHUDA.[RECLAMO](NUMERO_RECLAMO),
		CONSTRAINT FK_CUPON_RECLAMO_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES FUSECHUDA.[USUARIO](ID_USUARIO),
		CONSTRAINT FK_CUPON_RECLAMO_TIPO FOREIGN KEY (ID_TIPO_CUPON_RECLAMO) REFERENCES FUSECHUDA.[TIPO_CUPON_RECLAMO](ID_TIPO_CUPON_RECLAMO)
...
ALTER TABLE FUSECHUDA.CUPON_RECLAMO
	ADD	CONSTRAINT FK_CUPON_RECLAMO_NUMERO FOREIGN KEY (NUMERO_RECLAMO_CUPON) REFERENCES FUSECHUDA.[CUPON_DESC_RECLAMO](NUMERO_RECLAMO_CUPON),
		CONSTRAINT FK_CUPON_RECLAMO_PEDIDO FOREIGN KEY (NUMERO_PEDIDO) REFERENCES FUSECHUDA.[PEDIDO](NUMERO_PEDIDO)
...
ALTER TABLE FUSECHUDA.SERVICIO_MENSAJERIA
	ADD CONSTRAINT PK_SERVICIO_MENSAJERIA PRIMARY KEY (NUMERO_MENSAJERIA),
		...
		CONSTRAINT FK_MENSAJERIA_ESTADO FOREIGN KEY (ID_ESTADO) REFERENCES FUSECHUDA.MENSAJERIA_ESTADO(ID_ESTADO)
...
CREATE PROCEDURE FUSECHUDA.MIGRAR_TIPO_CUPON_RECLAMO AS
BEGIN
	INSERT INTO FUSECHUDA.TIPO_CUPON_RECLAMO(TIPO_CUPON_RECLAMO)
...
BEGIN
	INSERT INTO FUSECHUDA.SERVICIO_MENSAJERIA(NUMERO_MENSAJERIA, ID_USUARIO, ID_MdeP_USUARIO, PAQUETE_TIPO, DIREC_ORIGEN, DIREC_DESTINO, DISTANCIA, FECHA_MENSAJERIA,
												VALOR_ASEGURADO, PRECIO_SEGURO, TOTAL, ID_ESTADO, OBSERVACIONES, CALIFICACION, ID_LOCALIDAD )
	SELECT DISTINCT ENVIO_MENSAJERIA_NRO, usr.ID_USUARIO, mdpu.ID AS ID_MdeP_USUARIO, pqte.TIPO, ENVIO_MENSAJERIA_DIR_ORIG, ENVIO_MENSAJERIA_DIR_DEST, 
						...
						est.ID_ESTADO, ENVIO_MENSAJERIA_OBSERV, ENVIO_MENSAJERIA_CALIFICACION, localidad.ID_LOCALIDAD
	from gd_esquema.Maestra maestra
	LEFT JOIN FUSECHUDA.USUARIO usr ON usr.DNI = maestra.USUARIO_DNI and usr.NOMBRE = maestra.USUARIO_NOMBRE and usr.APELLIDO = maestra.USUARIO_APELLIDO
	...
	LEFT JOIN FUSECHUDA.MENSAJERIA_ESTADO est ON est.DESCRIPCION = maestra.ENVIO_MENSAJERIA_ESTADO
...
BEGIN
	INSERT INTO FUSECHUDA.PEDIDO(NUMERO_PEDIDO, ID_USUARIO, ID_LOCAL, ID_ESTADO, ID_MdeP_USUARIO, TARIFA_SERVICIO, TOTAL_PRODUCTOS, TOTAL_CUPONES, TOTAL_SERVICIO, 
								TOTAL, OBSERVACIONES, FECHA, CALIFICACION)
	SELECT DISTINCT PEDIDO_NRO, usr.ID_USUARIO, loc.ID_LOCAL, est.ID_ESTADO, mdpu.ID, PEDIDO_TARIFA_SERVICIO, PEDIDO_TOTAL_PRODUCTOS, PEDIDO_TOTAL_CUPONES, PEDIDO_TOTAL_SERVICIO, 
	...
	LEFT JOIN FUSECHUDA.MdeP_USUARIO mdpu ON mdpu.ID_USUARIO = usr.ID_USUARIO AND mdpu.NUMERO_TARJETA = maestra.MEDIO_PAGO_NRO_TARJETA
	LEFT JOIN FUSECHUDA.PEDIDO_ESTADO est ON est.DESCRIPCION = maestra.PEDIDO_ESTADO
...
BEGIN
	INSERT INTO FUSECHUDA.RECLAMO(NUMERO_RECLAMO, ID_USUARIO, NUMERO_PEDIDO, FECHA, ID_TIPO_RECLAMO, ID_OPERADOR, DESCRIPCION, ID_ESTADO, SOLUCION, FECHA_SOLUCION, CALIFICACION)
	SELECT DISTINCT RECLAMO_NRO, usr.ID_USUARIO, ped.NUMERO_PEDIDO, RECLAMO_FECHA, tiporec.ID_TIPO_RECLAMO, oper.ID_OPERADOR, RECLAMO_DESCRIPCION, est.ID_ESTADO, 
	...
	LEFT JOIN FUSECHUDA.RECLAMO_ESTADO est ON est.DESCRIPCION = maestra.RECLAMO_ESTADO
	WHERE RECLAMO_NRO  IS NOT NULL
END
GO

CREATE PROCEDURE FUSECHUDA.MIGRAR_CUPON_DESC_RECLAMO AS
BEGIN
	INSERT INTO FUSECHUDA.CUPON_DESC_RECLAMO(NUMERO_RECLAMO_CUPON, NUMERO_RECLAMO, ID_USUARIO, ID_TIPO_CUPON_RECLAMO, MONTO_RECLAMO, FECHA_RECLAMO_ALTA, FECHA_RECLAMO_VENCIMIENTO)
	SELECT DISTINCT CUPON_RECLAMO_NRO, RECLAMO_NRO, usr.ID_USUARIO, tipocuponreclamo.ID_TIPO_CUPON_RECLAMO, CUPON_RECLAMO_MONTO, CUPON_RECLAMO_FECHA_ALTA, CUPON_RECLAMO_FECHA_VENCIMIENTO
	from gd_esquema.Maestra maestra
	LEFT JOIN FUSECHUDA.USUARIO usr on usr.DNI = maestra.USUARIO_DNI and usr.NOMBRE = maestra.USUARIO_NOMBRE and usr.APELLIDO = maestra.USUARIO_APELLIDO
	LEFT JOIN FUSECHUDA.TIPO_CUPON_RECLAMO tipocuponreclamo ON tipocuponreclamo.TIPO_CUPON_RECLAMO = maestra.CUPON_RECLAMO_TIPO
...
BEGIN
	INSERT INTO FUSECHUDA.CUPON_RECLAMO(NUMERO_RECLAMO_CUPON, NUMERO_PEDIDO)
	SELECT DISTINCT CUPON_RECLAMO_NRO, PEDIDO_NRO
	from gd_esquema.Maestra maestra
...
CREATE PROCEDURE FUSECHUDA.MIGRAR_PEDIDO_ESTADO AS
BEGIN
	INSERT INTO FUSECHUDA.PEDIDO_ESTADO(DESCRIPCION)
...
CREATE PROCEDURE FUSECHUDA.MIGRAR_MENSAJERIA_ESTADO AS
BEGIN
	INSERT INTO FUSECHUDA.MENSAJERIA_ESTADO(DESCRIPCION)
...
CREATE PROCEDURE FUSECHUDA.MIGRAR_RECLAMO_ESTADO AS
BEGIN
	INSERT INTO FUSECHUDA.RECLAMO_ESTADO(DESCRIPCION)
...
EXEC FUSECHUDA.MIGRAR_CUPON_DESC_RECLAMO
